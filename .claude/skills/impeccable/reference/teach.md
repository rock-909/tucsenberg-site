...
- **DESIGN.md** (visual): visual theme, color palette, typography, components, layout. For this starter, this is a project-local design operating model. Answers "how it looks".
