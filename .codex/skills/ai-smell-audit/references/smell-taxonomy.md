...
**Detection**:
- Identify the canonical site-definition layer(s) for this project (check `.claude/rules/architecture.md` or project conventions; for this starter it's `src/config/single-site*.ts`, `src/config/site-facts.ts`).
