---
name: simplify
description: Review changed code for reuse, quality, and efficiency, then fix any issues found. Use when the user wants a cleanup pass, code review, or refactor sweep on recent changes (e.g. "simplify", "clean this up", "review my changes").
user-invocable: true
---
