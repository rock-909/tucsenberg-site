...
- **Fixings** are site-specific: masonry, concrete, steel and timber each take different anchors. A serious supplier asks what your mounting surface is before quoting. (Ours does — include it in the optional message on [our RFQ form](/request-quote).)
