...
Prices, lead times, product configuration, packaging, delivery terms and custom options are confirmed only in a written quotation. We reply within 12 hours. When enough information is supplied for pricing, the quotation follows; otherwise we ask only for the missing essentials.
