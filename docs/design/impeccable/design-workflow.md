...
4. Storybook stories
5. `docs/design/impeccable/system/COMPONENT-GOVERNANCE.md`
...
2. Check `docs/design/impeccable/system/COLOR-SYSTEM.md`.
...
See `docs/design/impeccable/system/MOTION-PRINCIPLES.md`.
