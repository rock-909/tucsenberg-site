...
- Do not import Radix Themes from business code. Radix Themes is pilot-only and may be used only through approved `src/components/ui/*` wrappers; see `docs/ref/decisions/ui-foundation.md`.
