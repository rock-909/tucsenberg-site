...
| File | Purpose |
|------|---------|
| `docs/design/impeccable/system/COLOR-SYSTEM.md` | Current color system |
| `docs/design/impeccable/system/SECTION-REDESIGN-CHECKLIST.md` | Section redesign checklist |
