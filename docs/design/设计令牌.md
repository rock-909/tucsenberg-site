...
> Current contract sources: `src/app/globals.css` and `docs/design/色彩系统.md`.
...
- If token roles change, update `色彩系统.md` and related contract tests in the same change.
