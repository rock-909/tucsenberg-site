...
`docs/proof/performance/lighthouse-yellow-debt-wave-1-closeout.md`. The Wave 2
...
python3 .codex/skills/avoid-ai-tropes/scripts/check.py docs/proof/performance/lighthouse-yellow-debt-wave-2-closeout.md
git diff --check -- docs/proof/performance/lighthouse-yellow-debt-wave-2-closeout.md
```
