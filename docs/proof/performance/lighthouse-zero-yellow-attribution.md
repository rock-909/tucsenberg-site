...
| `python3 .codex/skills/avoid-ai-tropes/scripts/check.py docs/proof/performance/lighthouse-zero-yellow-attribution.md` | Pass. No AI-trope patterns detected. |
| `git diff --check -- docs/proof/performance/lighthouse-zero-yellow-attribution.md docs/superpowers/specs/2026-05-24-lighthouse-zero-yellow-attribution-design.md docs/superpowers/plans/2026-05-24-lighthouse-zero-yellow-attribution.md` | Pass. No whitespace errors. |
