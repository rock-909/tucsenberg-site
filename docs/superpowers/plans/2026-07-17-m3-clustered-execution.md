...
**Current blocker (2026-07-18):** PR #130 implements C2; default CI on head `c2bc6433a1c96389e51f7549dabd424829f8ce98` is green (run `29635461622`). The manual Airtable phone proof on that exact head failed with `NOT_FOUND/404` (run `29635625930`). Status: CODE_COMPLETE_EXTERNAL_PROOF_BLOCKED. Do not mark C2 READY, do not merge C2, do not start D6a/D5a until a green proof run on the exact C2 SHA succeeds against the real Base, table name, and `WhatsApp / Phone` column.
