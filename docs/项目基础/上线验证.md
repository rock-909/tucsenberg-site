...
`派生干跑验证.md` and `生命周期.md` only when maintaining retained starter
machinery.
...
compat/generated files. `src/constants/product-specs/**` is retained
starter/adopter compatibility material, not current Tucsenberg launch truth.
