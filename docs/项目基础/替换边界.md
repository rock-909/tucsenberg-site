...
| product catalog | `must-replace` | Current Tucsenberg product-page runtime truth: `src/constants/tucsenberg-product-pages.ts`. Catalog route/list adapters: `src/config/single-site-product-catalog.ts`, `src/config/site-types.ts` | product page contract tests for current Tucsenberg pages |
...
`src/config/site-types.ts` provide the route/list/catalog adapters.

## Do not edit first

- `src/config/paths/site-config.ts`: runtime/validation facade; edit `src/config/single-site.ts` first.
- `src/constants/product-catalog.ts`: query facade; edit current product page truth in `src/constants/tucsenberg-product-pages.ts` or route/list adapters in `src/config/single-site-product-catalog.ts` and `src/config/site-types.ts` first.
