...
| UI messages | `review-or-tune` | `messages/base/**`, `messages/profiles/b2b-lead/**`, `messages/profiles/catalog/**`, compat `messages/{locale}/messages.json` | `pnpm messages:sync && pnpm content:check` |
