...
> and `scripts/starter-profile` materialize tooling and the profile fixtures no
> longer exist. This page is kept only as background on how the site was derived.
