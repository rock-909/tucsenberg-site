...
| `AGENTS.md` | `site-long-term` | Cross-tool current Tucsenberg project instructions; keep aligned with `docs/README.md` and `docs/项目基础/项目基础.md`. |
...
| React Doctor | `site-long-term` | yes | no | no | Runs through `react-doctor@latest`; latest-version drift is accepted and documented in `docs/项目基础/ReactDoctor政策.md`. |
