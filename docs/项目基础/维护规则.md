...
- `docs/archive/**` 和 `docs/superpowers/plans/**` 默认是历史材料。 <!-- truth-docs:allow-missing -->
...
- Upstream Superpowers history previously used `docs/plans/**`; do not reintroduce that older path. <!-- truth-docs:allow-missing -->
...
- `docs/archive/**`, if restored, is not current truth. <!-- truth-docs:allow-missing -->
