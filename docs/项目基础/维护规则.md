...
- Messages: physical packs under `messages/base/**`, `messages/profiles/b2b-lead/**`, and `messages/profiles/catalog/**`; compat files such as `messages/en/messages.json` are generated surface.
