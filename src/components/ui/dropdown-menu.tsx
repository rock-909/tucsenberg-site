  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-[inset=true]:pl-8 data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:text-destructive",
        className,
      )}
      {...props}
    />
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "focus:bg-muted focus:text-foreground data-[state=open]:bg-muted data-[inset=true]:pl-8",
        className,
      )}
      {...props}
    >
