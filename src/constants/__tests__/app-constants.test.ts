...
describe("app-constants", () => {
  describe("TIME_CONSTANTS", () => {
    ...
    it("exposes stable numeric time constants", () => {
      expect(Object.keys(TIME_CONSTANTS)).toStrictEqual([
        "SECOND",
        "MINUTE",
        "HOUR",
        "FULL_DAY",
      ...
      expect(Object.values(TIME_CONSTANTS).every(Number.isFinite)).toBe(true);
    });
  });
